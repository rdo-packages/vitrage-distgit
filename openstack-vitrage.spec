...
Requires:         python2-cotyledon >= 1.6.3
...
%changelog
* Tue Jan 08 2019 RDO <dev@lists.rdoproject.org> 3.3.0-1
- Update to 3.3.0

* Thu Aug 23 2018 RDO <dev@lists.rdoproject.org> 3.2.0-1
- Update to 3.2.0

* Thu Aug 16 2018 RDO <dev@lists.rdoproject.org> 3.1.0-1
- Update to 3.1.0
